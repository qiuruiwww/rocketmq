...
public class DefaultMQPushConsumer extends ClientConfig implements MQPushConsumer {
     ...
     *
     * 并发消息消费时处理队列最大跨度，默认为2000，表示如果消息处理队列中偏移量最大的消息与偏移量最小的消息的跨度超过2000则延时50毫秒后再拉取消息
     */
     ...
     *
     * 消息并发消费时一次消费消息条数，就是每次传入consumeMessage的消息条数
     */
